  ...
  return (
    <section data-testid="photoWrap" className="photoWrap">
      <article className="introWrap">
        <h1 data-testid="photoIntro" className="bigIntro" id="workIntro">Photography and technology fit together surprisingly well.
        </h1>
      ...
      <section className="cardWrap" style={{backgroundImage: 'url(' + product + ')' }}>
        <article className="card" id="quoteCard">
          <section className="infoWrap" id="quoteCard">
            <h2 className="photoCardTitle">Products</h2>
            <a href="http://www.kameraproduct.com" className="photoLinks">
              Visit KAMera Product Stories
            </a>
            <p data-testid="productsText" className="photoDes">After several years of photographing people, I stumbled upon the art of product photography. I found myself in a job working as a Photoshop editor for a team of product photographers for an e-commerce company. Products can either come to life or die in a single photograph. In the digital world, a single photo can be the determining factor of whether a product sells or doesn't sell. It was this power that sent me straight into the arms of professional product photography.
            <br/><br/>Product photography is what launched my side business into a full-time job. After building up a client base, I was soon able to open up a studio and start shooting product photos full time. I know the importance of great product photography and product storytelling. I also know the importance that those photos can have on a business' brand.</p>
          </section>
        </article>
      </section>
    </section>
